...
export const translations: Record<Lang, Translations> = {
  es: {
    ...
    footerLegal: 'Un crédito le compromete y debe ser reembolsado. Verifique su capacidad de pago antes de comprometerse. Atención WhatsApp directa al +34 672 07 20 61.',
    ...
    whatsappHint: 'Haga clic para contactar directamente con su asesor en WhatsApp (+34 672 07 20 61)',
  ...
  fr: {
    ...
    footerLegal: 'Un crédit vous engage et doit être remboursé. Vérifiez vos capacités de remboursement avant de vous engager. Assistance WhatsApp directe au +34 672 07 20 61.',
    ...
    whatsappHint: 'Cliquez pour envoyer directement votre récapitulatif à notre conseiller dédié (+34 672 07 20 61)',
  ...
  en: {
    ...
    footerLegal: 'A loan commits you and must be repaid. Check your repayment capacity before committing. Direct WhatsApp assistance at +34 672 07 20 61.',
    ...
    whatsappHint: 'Click to transmit your full summary directly to your dedicated loan officer (+34 672 07 20 61)',
  ...
  de: {
    ...
    footerLegal: 'Ein Kredit verpflichtet und muss zurückgezahlt werden. WhatsApp-Hilfe: +34 672 07 20 61.',
    ...
    whatsappButton: 'Unterlagen per WhatsApp senden (+34 672 07 20 61)',
  ...
  it: {
    ...
    footerLegal: 'Il credito ti impegna e deve essere restituito. Verifica la tua capacità di rimborso. WhatsApp: +34 672 07 20 61.',
    ...
    whatsappButton: 'Invia pratica su WhatsApp (+34 672 07 20 61)',
  ...
  pt: {
    ...
    footerLegal: 'O crédito compromete-o e deve ser reembolsado. Verifique a sua capacidade de reembolso. Apoio direto por WhatsApp: +34 672 07 20 61.',
    ...
    whatsappButton: 'Enviar processo pelo WhatsApp (+34 672 07 20 61)',
